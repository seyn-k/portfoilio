            ...
            <div className="header-content">
                <div className="header-main">
                    ...
                    <div className="header-cta">
                        ...
                        <a href="https://drive.google.com/file/d/1J7g1XKTQCFV8uGHjEIiLrudOK2ELogzs/view?usp=sharing" className="cta-button primary" target="_blank" rel="noopener noreferrer">
                            Resume
                        </a>
                    </div>
                </div>
